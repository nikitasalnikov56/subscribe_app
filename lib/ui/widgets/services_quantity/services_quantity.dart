...
class ServicesQuantity extends StatelessWidget {
  const ServicesQuantity({super.key});
            ...
            children: [
              ...
              Expanded(
                child: ListView.separated(
                  itemBuilder: (context, i) {
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        title: Center(
                          child: Text(AppArrays.servicesQuantity[i],
                  ...
                  itemCount: AppArrays.servicesQuantity.length,
                ),
              ),
            ],
          );
