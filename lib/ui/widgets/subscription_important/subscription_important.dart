...
class SubscriptionImportant extends StatelessWidget {
  const SubscriptionImportant({super.key});
            ...
            children: [
              ...
              Expanded(
                child: ListView.separated(
                  itemBuilder: (context, i) {
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        title: Center(
                          child: Text(AppArrays.importantAccess[i],
                  ...
                  itemCount: AppArrays.importantAccess.length,
                ),
              ),
            ],
          );
